...
const StatBlock: React.FC = () => {
    ...
    return (
        <div className='w-full px-2'>
            <div className="bg-[#000000]/[.12] backdrop-blur-sm rounded-xl p-[10px] w-full">
                {dataItems.map((item, index) => (
                    <>
                        <div key={index} className={`flex items-center justify-between text-white pl-[12px] mb-[10px] ${dataItems.length - 1 > index ? "border-b border-[#FFFFFF]/[0.1] pb-[10px]" : ""}`}>
