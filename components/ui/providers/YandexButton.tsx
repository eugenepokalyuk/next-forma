...
const YandexButton = () => {
    ...
    const callbackUrl = searchParams && searchParams.get("callbackUrl") || "/info";

    return (
        <button
            onClick={() => signIn("yandex", { callbackUrl })}
            className='flex justify-center gap-2 px-4 py-3 bg-white text-black rounded-lg overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-105 active:scale-95 w-full mb-2'
        >
            <svg
